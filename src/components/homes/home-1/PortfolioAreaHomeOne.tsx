    ...
    <>
      <div className="uxora-section-padding2 section">
        <div className="container">
          <div className="uxora-section-title center" data-anime="onview: -100; targets: >*; translateY:; opacity:; easing: spring(1, 80, 10, 0); duration: 450; delay: anime.stagger(100, {start: 400});">
